...
<div class="panel panel-default">
    <div class="panel-heading">
        <h4>Grafik Nilai Keaktifan Divisi</h4>
    </div>
...
<div class="form-row">
  <div class="form-group col-md-6">
    <center><a href="<?php echo site_url('Eksekutif/pdf') ?>" type="button" class="btn btn-default"><i class="fa fa-print"></i> Laporan Keaktifan Divisi (PDF)</a>

  </div>
  <div class="form-group col-md-6 ">
    <center><a href="<?php echo site_url('Eksekutif/export') ?>" type="button" class="btn btn-default"><i class="fa fa-download"></i> Laporan Keaktifan Divisi (Excel)</a>

...
<div class="form-row">
  ...
  <div class="form-group col-md-6 ">
    ...
    <div class="h5">
      <i>Anda adalah <b>Manajer</b> dari Divisi <b><?php echo $divreal; ?></b></i>
    </div>
    <div>
    ...
    <br>
    <div>
      <a href="<?php echo site_url('Manajer/aksiUpdateProfileManajer/'.$key->id) ?>" type="button" name="button" class="btn btn-primary"><div class="glyphicon glyphicon-pencil"></div> Edit Profile</a>
    </div>
  </div>
</div>
</div>
